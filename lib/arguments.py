...
PRIMARY_KEYS = ['datasets', 'model', 'multiview', 'stereopair_settings', 'training_settings', 'optimizer', 'scheduler', 'general', 'output']
PRIMARY_KEYS_MANDATORY = ['datasets', 'output']

# --------------------------------- Secondary keys (Training) --------------------------------- #

DATASET_KEYS_MANDATORY_train = ['raster_gt', 'raster_in', 'area_type']
DATASET_KEYS_OPTIONAL = ['name', 'path_image_list', 'path_pairlist_training', 'path_pairlist_validation', 'n_training_samples', 'allocation_strategy', 'test_stripe', 'crossval_training', 'mask_ground_truth']
MODEL_KEYS = ['name', 'input_channels', 'depth', 'start_kernel', 'act_fn_encoder', 'act_fn_decoder', 'act_fn_bottleneck', 'up_mode', 'do_BN', 'bias_conv_layer', 'outer_skip', 'outer_skip_BN', 'pretrained_path']
...
DATASET_KEYS_OPTIONAL_eval = ['name', 'raster_gt', 'path_image_list', 'path_pairlist', 'mask_ground_truth',
                              ...
                              'area_type', 'crossval_training','land_mask']
